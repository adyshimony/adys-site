 ...
 * @returns {any}
 */
export function compile_unified(expression, options_js) {
    const ptr0 = passStringToWasm0(expression, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_unified(ptr0, len0, options_js);
    return ret;
}
 ...
 * @returns {any}
 */
export function lift_to_miniscript(bitcoin_script) {
    const ptr0 = passStringToWasm0(bitcoin_script, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.lift_to_miniscript(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function analyze_miniscript(expression, context) {
    const ptr0 = passStringToWasm0(expression, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(context, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.analyze_miniscript(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {any}
 */
export function get_wasm_build_info() {
    const ret = wasm.get_wasm_build_info();
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_6a6a94f5bc7eba82 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('miniscript_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
