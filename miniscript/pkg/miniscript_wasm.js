 ...
 * @returns {any}
 */
export function compile_policy(policy, context) {
    ...
    const ret = wasm.compile_policy(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {any}
 */
export function compile_miniscript(expression, context) {
    const ptr0 = passStringToWasm0(expression, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(context, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.compile_miniscript(ptr0, len0, ptr1, len1);
    return ret;
}
